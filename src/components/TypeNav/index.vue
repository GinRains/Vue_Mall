<template>
  <div class="type-nav">
    <div class="container">
      <div @mouseleave="shiftOutItem" @mouseenter="showSort">
        <h2 class="all">全部商品分类</h2>
        <div class="sort" v-show="isShow">
          <div class="all-sort-list2" @click="toSearch">
            <div class="item" v-for="(category, index) in categoryList"
                 @mouseenter="acrossItem(index)"
              ...
              <div class="item-list clearfix">
                <div class="subitem">
                  <dl class="fore" v-for="variety in category.categoryChild"
...
<script>
  ...
  export default {
    ...
    methods: {
      acrossItem: throttle(function(index) {
