<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="cart in cartList" :key="cart.skuId">
          <li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{totalGoodsNum}}</i>件商品，总商品金额</b>
          <span>¥{{totalGoodsPrice}}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{totalGoodsPrice}}.00</span></div>
