<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span>{{navView.category1Name}}</span>
        <span>{{navView.category2Name}}</span>
        <span>{{navView.category3Name}}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :currentIndex="defaultIndex" :skuInfo="skuInfo"/>
          <!-- 小图列表 -->
          <ImageList @changeIndex="changeIndex" :imgList="skuInfo.skuImageList" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeChecked(spuSaleAttr.spuSaleAttrValueList, index)"
  ...
  export default {
    ...
    methods: {
      getGoodsInfo() {
        ...
        this.$store.dispatch("gainGoodsInfo", skuId)
      },
      changeChecked(skuList, index) {
    ...
    computed: {
      ...
      ...mapGetters(["navView", "spuSaleAttrList", "skuInfo"])
    },
    components: {
      ImageList,
      Zoom
