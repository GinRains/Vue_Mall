<template>
  <div class="register-container">
    ...
    <div class="register">
      <h3>注册新用户
        <span class="go">我有账号，去 <router-link href="javascript:;" to="/login">登陆</router-link>
        </span>
      </h3>
      <div class="content">
        <label>手机号:</label>
      ...
      <div class="content">
        ...
        <img ref="code" src="/api/user/passport/code" alt="code" @click="$event.target.src = '/api/user/passport/code'">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
